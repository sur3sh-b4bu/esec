# AGENT RULES & SECURITY CONSTRAINTS

## Strict Security Rules (Mandatory for ALL AI Agents: Claude, Antigravity, etc.)

> [!CAUTION]
> **NEVER TOUCH ENVIRONMENT & SENSITIVE CONFIG FILES**
...
> 3. These restrictions apply universally to all agents, tools, and scripts.
